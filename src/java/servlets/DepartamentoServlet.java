...
public class DepartamentoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("nome") != null && !request.getParameter("nome").isEmpty()){
            ...
            departamento.setImagemUrl(request.getParameter("imagem_url"));
            
            dao.save(departamento);
        } else if (request.getParameter("excluir") != null) {
            dao.delete(dao.find(Integer.parseInt(request.getParameter("excluir"))));
        } else if (request.getParameter("atualizar") != null) {
            request.setAttribute("departamento", dao.find(Integer.parseInt(request.getParameter("atualizar"))));
        }
        
        request.setAttribute("departamentos", dao.list());
        
        RequestDispatcher view = request.getRequestDispatcher("Departamento.jsp");
